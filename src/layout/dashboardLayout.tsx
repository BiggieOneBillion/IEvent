...
const DashboardLayout = () => {
  ...
  return (
    <section className="flex h-screen w-screen justify-start items-start">
      <nav
        className={`w-[300px] py-5 px-2 lg:py-5 lg:px-4 fixed bg-white top-0 left-0 h-screen z-10 lg:relative lg:w-[300px] border-r ${
      ...
      <section className="flex-1 h-screen overflow-y-autoy flex flex-col">
        ...
        <div className="h-16 md:h-14 flex items-center justify-between md:justify-start border-b px-2 md:px-10">
          ...
          <section className="flex items-center md:justify-between md:w-full gap-2 md:gap-5">
        ...
        <main className="px-2 py-5 lg:px-10 overflow-y-auto flex-1">
